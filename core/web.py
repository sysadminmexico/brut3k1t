...
def usercheck(username, service):
    try:
...
def webBruteforce(username, wordlist, service, delay):
    driver = webdriver.Firefox()
    if service == "facebook":
    ...
    for i in wordlist.readlines():
        ...
        try:
            ...
            print R + ("[!] OOPs, something went wrong. Exception: %s [!]" % e) + W
            sys.exit(1)
